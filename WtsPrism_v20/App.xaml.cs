...
using WtsPrism_v20.Views;

namespace WtsPrism_v20
{
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "WtsPrism_v20.ViewModels.{0}ViewModel, WtsPrism_v20", viewType.Name.Substring(0, viewType.Name.Length - 4));
